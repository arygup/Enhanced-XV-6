...
forktest(void)
{
  ...
  3e:	43650513          	add	a0,a0,1078 # 470 <set_priority+0xc>
  ...
  68:	41c50513          	add	a0,a0,1052 # 480 <set_priority+0x1c>
  ...
  b8:	41c50513          	add	a0,a0,1052 # 4d0 <set_priority+0x6c>
  ...
  d4:	3d050513          	add	a0,a0,976 # 4a0 <set_priority+0x3c>
  ...
  ee:	3ce50513          	add	a0,a0,974 # 4b8 <set_priority+0x54>
