...
int main(int argc, char **argv)             // copilot
{
  ...
  16:	82e58593          	add	a1,a1,-2002 # 840 <malloc+0xee>
  1a:	4509                	li	a0,2
  1c:	00000097          	auipc	ra,0x0
  20:	650080e7          	jalr	1616(ra) # 66c <fprintf>
        exit(1);
  24:	4505                	li	a0,1
  ...
  36:	1de080e7          	jalr	478(ra) # 210 <atoi>
  3a:	892a                	mv	s2,a0
    int pid = atoi(argv[2]);
  3c:	6888                	ld	a0,16(s1)
  ...
  50:	37e080e7          	jalr	894(ra) # 3ca <set_priority>
  54:	85aa                	mv	a1,a0
    if(oldpriority == -1)
  56:	57fd                	li	a5,-1
  58:	02f50163          	beq	a0,a5,7a <main+0x7a>
    {
        exit(1);
    }
  ...
  64:	80850513          	add	a0,a0,-2040 # 868 <malloc+0x116>
  68:	00000097          	auipc	ra,0x0
  6c:	632080e7          	jalr	1586(ra) # 69a <printf>
    exit(0);
  70:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 41a:	4ea50513          	add	a0,a0,1258 # 900 <digits>
 41e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 51e:	38e70713          	add	a4,a4,910 # 8a8 <malloc+0x156>
 ...
 5a8:	35cb8b93          	add	s7,s7,860 # 900 <digits>
 ...
 5fc:	2a890913          	add	s2,s2,680 # 8a0 <malloc+0x14e>
        while(*s != 0){
